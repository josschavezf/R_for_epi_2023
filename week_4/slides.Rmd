...
How it looks like using the function View( )?
...
- Extract the name and last name
- Extract the glucose levels from days 3 to 5
- Remove the weight
...
- How do you extract the age of Noah using the previous result?
