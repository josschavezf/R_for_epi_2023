...
MRS <- read_csv("data/methicillin-resistant-staphylococcus-aureus-mrsa-bloodstream-infections-bsi-in-california-hospitals.csv")
...
model2 <- lm(MRS_Incidence ~  Patient_Days, data = MRS)
summary(model2)
